        ...
        <div className="flex justify-between items-center h-20 sm:h-24">
          ...
          >
            ...
            >
              <Image
                src="/images/logo.png"
                alt="Lucky Driving School — Professional Driving Lessons in Edmonton, Alberta"
                width={50}
                height={50}
            ...
            <div className="hidden xs:block">
              ...
              >
                <span className="font-serif text-lg sm:text-xl font-bold bg-gradient-to-r from-white to-slate-200 bg-clip-text text-transparent group-hover:from-white group-hover:to-secondary transition-all duration-300">Lucky</span>
