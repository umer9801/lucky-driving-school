        ...
        >
          ...
          <motion.div variants={fadeInUp} className="space-y-4">
            ...
            >
              <Image
                src="/images/logo.png"
                alt="Lucky Driving School — Driving Lessons Edmonton, Alberta"
                width={50}
                height={50}
            ...
            <div>
              ...
              <p className="text-slate-300 leading-relaxed text-xs sm:text-sm">Edmonton's top-rated driving school offering professional driving lessons, Class 5 and Class 7 road test preparation, and defensive driving courses in Alberta, Canada. Trusted by 500+ students with a 95% first-attempt pass rate.</p>
            </div>
            <motion.div variants={containerVariants} className="flex gap-3">
              {[
                ...
                <motion.a
                  key={index}
                  href={href}
                  aria-label={index === 0 ? 'Visit Lucky Driving School on Facebook' : index === 1 ? 'Visit Lucky Driving School on Twitter' : 'Visit Lucky Driving School on Instagram'}
