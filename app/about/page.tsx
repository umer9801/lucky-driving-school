      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                ...
                transition={{ duration: 0.6 }}
              >
                <h2 className="font-serif text-4xl font-bold text-primary mb-6">Edmonton's Most Trusted Driving School</h2>
                <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                  Lucky Driving School is dedicated to producing safe, confident drivers across Edmonton and surrounding Alberta communities. Our Alberta Transportation approved training program combines patient, one-on-one instruction with modern teaching techniques — helping students of all experience levels master the skills needed to pass their Class 5 or Class 7 road test on the first attempt.
                </p>
                <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                  Whether you are a first-time driver, an international license holder, or someone looking to rebuild confidence behind the wheel, our certified instructor Lakshmi brings over a decade of professional driving education experience to every lesson. We proudly serve South Edmonton, Windermere, Summerside, Millwoods, Terwillegar, Riverbend, Sherwood Park, St. Albert, Beaumont, Leduc, and Spruce Grove.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  We believe that driving education is more than just passing a test—it is about building safe habits, behind-the-wheel confidence, and a genuine commitment to road safety. That is why we combine proven teaching methods with personalized attention to ensure every student reaches their full potential.
                </p>
              </motion.div>
                  ...
                  {[
                    {
                      ...
                      desc: 'Driving lessons available 7 days a week across Edmonton. Morning, afternoon, and evening time slots to fit your schedule. We come to you.',
                    },
                    {
                      icon: Shield,
                      title: 'Safety Guaranteed',
                      desc: 'All vehicles equipped with dual controls and fully insured, providing a safe learning environment.',
                    },
                    {
                      icon: Heart,
                      title: 'Patient Instructors',
                      desc: 'Supportive teaching approach tailored specifically for nervous beginners and adult learners.',
                    },
                    {
                      icon: TrendingUp,
                      title: 'Proven Track Record',
                      desc: '95% first-attempt pass rate and hundreds of licensed graduates in Alberta.',
                    },
                  ].map((item, index) => {
        ...
        <section className="py-16 md:py-24 bg-primary text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { number: '500+', label: 'Alberta Licensed Drivers' },
        ...
        <section className="py-16 md:py-24 bg-gray-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              Start Your Driving Journey in Edmonton
            </motion.h2>
            <motion.p
              initial="hidden"
              whileInView="visible"
            ...
            >
              Join over 500 students who have successfully earned their Alberta driver's licence with Lucky Driving School. Book your first lesson today and experience patient, professional instruction from Edmonton's top-rated driving school.
            </motion.p>
            <motion.div
              initial="hidden"
              whileInView="visible"
