  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        >
          <HeroSection
            title="Contact Lucky Driving School in Edmonton"
            subtitle="Ready to start your driving journey? Get in touch with Edmonton's top-rated driving school. We are here to answer your questions about driving lessons, road test preparation, course packages, and scheduling."
              ...
              >
                ...
                >
                  {[
                    {
                      title: 'Book a Lesson',
                      desc: 'Ready to start your driving journey? Contact us to schedule your first lesson. We serve Edmonton, South Edmonton, Windermere, Millwoods, Sherwood Park, and surrounding Alberta communities.',
                    },
                    {
                      title: 'Ask Questions',
                      desc: 'Unsure which course is right for you? Our certified instructor is available to discuss your driving goals and recommend the best course package for your experience level.',
                    },
                    {
                      title: 'Road Test Prep',
                      desc: 'Preparing for your Class 5 or Class 7 road test? Get in touch to book specialized road test preparation lessons with our experienced instructors.',
                    },
                    {
                      title: 'Special Requests',
                      desc: 'Need winter driving training or brush-up lessons? Let us know! We customize our driving courses to meet individual needs and learning preferences.',
                    },
                  ].map((item, index) => (
                    <motion.div 
                      key={index}
