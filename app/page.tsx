      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-center text-gray-600 text-lg mb-12 text-pretty">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              {[
                ...
                <div key={index} className="bg-gradient-to-br from-primary to-blue-600 text-white p-6 rounded-lg">
        ...
        <section className="py-16 md:py-24 bg-primary text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="font-serif text-4xl font-bold mb-6">Ready to Start Learning?</h2>
