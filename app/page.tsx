      ...
      <main className="min-h-screen bg-white">
        ...
        >
          ...
          <div className="relative z-10 text-left text-white px-4 sm:px-6 lg:px-8 max-w-4xl w-full py-24 sm:py-0">
            ...
            >
              Edmonton's #1 Rated <span className="text-secondary">Driving School</span>
            </motion.h1>
            ...
            >
              Professional driving lessons, Class 5 & Class 7 road test preparation, and defensive driving courses in Edmonton, Alberta. Trusted by 500+ students with a 95% first-attempt pass rate.
            </motion.p>
              ...
              {[
                {
                  ...
                  description: 'Alberta Transportation certified driving instructors with 10+ years of professional experience training Edmonton drivers for Class 5 and Class 7 road tests.',
                  color: 'from-blue-500 to-blue-600',
                },
                {
                  icon: CheckCircle,
                  title: 'Proven Results',
                  description: '95% first-attempt road test pass rate and hundreds of licensed graduates in Alberta.',
                  color: 'from-green-500 to-green-600',
                },
                {
                  icon: Users,
                  title: 'Personalized Learning',
                  description: 'Tailored behind-the-wheel instruction custom-fit for your specific experience, skill level, and learning pace.',
                  color: 'from-purple-500 to-purple-600',
                },
                {
                  icon: Zap,
                  title: 'Flexible Scheduling',
                  description: 'Driving lessons scheduled 7 days a week with convenient morning, afternoon, and evening time slots.',
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-12 items-center">
              ...
              >
                ...
                <p className="text-sm sm:text-base md:text-lg text-slate-600 mb-6 sm:mb-8 leading-relaxed">
                  Lucky Driving School is Edmonton's premier choice for certified driving lessons, GDL brush-up courses, and Class 5 road test preparation. Our Alberta Transportation approved programs are designed to help you build confidence, master defensive driving habits, and navigate complex road scenarios safely in Alberta, Canada.
                </p>
        ...
        <section className="py-12 sm:py-16 md:py-24 bg-slate-50 relative overflow-hidden border-t border-slate-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              initial="hidden"
              whileInView="visible"
              ...
              className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-10 sm:mb-12 text-primary"
            >
              Driving Lessons Across Edmonton & Surrounding Areas
            </motion.h2>
            <p className="text-sm sm:text-base md:text-lg text-slate-600 max-w-2xl mx-auto text-center mb-10">
              We offer convenient home pickup and drop-off services for our students across Edmonton and adjacent communities.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              {[
                'South Edmonton', 'Windermere', 'Summerside', 'Millwoods',
                'Terwillegar', 'Riverbend', 'Ellerslie', 'Heritage Valley',
                'Sherwood Park', 'St. Albert', 'Beaumont', 'Leduc'
              ].map((area, idx) => (
                <div key={idx} className="p-4 bg-white rounded-lg shadow-sm border border-slate-100 flex items-center gap-3 justify-center">
                  <div className="w-2 h-2 rounded-full bg-secondary"></div>
                  <span className="font-semibold text-primary text-sm sm:text-base">{area}</span>
                </div>
              ))}
            </div>
          </div>
