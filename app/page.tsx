      ...
      <main className="min-h-screen bg-white">
        ...
        >
          ...
          <div className="relative z-10 text-left text-white px-4 sm:px-6 lg:px-8 max-w-4xl">
            <motion.div
              ...
              className="mb-6"
            >
              <span className="inline-flex items-center gap-2 bg-secondary/90 text-white px-4 py-2 rounded-full text-sm font-semibold uppercase tracking-wider">
                <Trophy size={18} />
        ...
        <section className="py-20 md:py-32 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <span className="inline-block text-secondary font-bold text-sm uppercase tracking-widest mb-4">Why Choose Us</span>
              ...
              {[
                ...
                return (
                  <motion.div
                    ...
                    className="group relative card-premium bg-white border-2 border-slate-100 hover:border-slate-200 overflow-hidden"
                  >
                    {/* Premium Gradient Overlay */}
                    ...
                    <div className="relative z-10">
                      ...
                      <motion.div
                        ...
                        className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-6 group-hover:scale-125 transition-all duration-300 shadow-lg group-hover:shadow-2xl`}
                      >
                        <Icon className="text-white" size={32} />
                      </motion.div>
                      
                      <h3 className="font-serif text-2xl font-bold mb-3 text-primary group-hover:text-secondary transition-colors duration-300">
                        {feature.title}
                      </h3>
                      <p className="text-slate-600 leading-relaxed group-hover:text-slate-700 transition-colors duration-300 text-premium">
                        {feature.description}
                      </p>
                    </div>
        ...
        <section id="courses" className="py-20 md:py-32 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.div
              ...
              className="text-center mb-16"
            >
              <span className="inline-block text-secondary font-bold text-sm uppercase tracking-widest mb-4">Our Packages</span>
              <h2 className="font-serif text-4xl md:text-5xl font-bold text-primary mb-6">
            ...
            >
              {[
                ...
                <motion.div 
                  ...
                  transition={{ type: "spring", stiffness: 300 }}
                  className="group relative card-premium bg-white border-2 border-slate-100 hover:border-secondary/40 overflow-hidden"
                >
